...
function OurGym() {
  return (
    <React.Fragment>
      <NavBar />
      <div className="our-gym-page-container">
          ...
          <div className="col-12 col-md-7">
            <div className="d-flex justify-content-evenly align-items-center">
              ...
              <p className=" w-50 text-center text-theme-blue">
                New to climbing? Fill out our waiver form to register and come
                on down!
              </p>
            </div>
            ...
            <div className="d-flex justify-content-evenly align-items-center h-33">
              ...
              <p className="text-theme-blue w-50 text-center">
                All kids are welcome! We have a special young-uns wall in our
                kids section.
              </p>
            </div>
          </div>
        ...
        <div className="welcome-get-started bg-theme-blue">
          ...
          <div className="get-started-store-group text-center">
            <p className="text-white">
              Check out our store if you're interesed!
            </p>
        ...
        <div className="welcome-see-you-soon bg-theme-purple text-center">
          <a
